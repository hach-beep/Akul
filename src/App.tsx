          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                <h1 className="font-display font-bold text-xl text-stone-900 leading-tight">
                  Akul
                </h1>
              ...
              <p className="text-xs text-stone-500 hidden sm:block">
                Smart Fridge Scanner & Culinary Planner
              </p>
            </div>
          </div>
      ...
      <footer className="mt-auto border-t border-stone-200 bg-white py-6 text-xs text-stone-500">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-2">
          <p className="font-medium text-stone-700">
            © {new Date().getFullYear()} Akul. All rights reserved.
          </p>
          <p className="text-stone-400">
            Intelligent Kitchen & Meal Assistant
          </p>
        </div>
      </footer>
